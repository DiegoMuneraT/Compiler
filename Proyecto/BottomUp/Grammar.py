...
2. Construir la tabla de analisis sintactico. Debe tener como filas los simbolos no terminales
    de la gramatica y como columnas los simbolos terminamos mas el simbolo adicional para el fin ("$").

3. Implementar el analizador como una funcion que recibe una cadena de entrada y una tabla de analisis sintactico.

4. Manejar errores sintacticos si en algun momento en la tabla no hay una regla de produccion para el simbolo
    no terminal en la cima de la pila y el simbolo terminal de la entrada
"""
